...
impl Parker {
    ...
    pub unsafe fn park(self: Pin<&Self>) {
        ...
        c::NtWaitForKeyedEvent(keyed_event_handle(), self.ptr(), false, ptr::null_mut());
    ...
    pub unsafe fn park_timeout(self: Pin<&Self>, timeout: Duration) {
        ...
        // Wait for unpark() to produce this event.
        let unparked =
            c::NtWaitForKeyedEvent(handle, self.ptr(), false, &mut timeout) == c::STATUS_SUCCESS;
        ...
        if !unparked && prev_state == NOTIFIED {
            ...
            c::NtWaitForKeyedEvent(handle, self.ptr(), false, ptr::null_mut());
        }
    }
    ...
    pub unsafe fn unpark(self: Pin<&Self>) {
        ...
        if self.state.swap(NOTIFIED, Release) == PARKED {
            ...
            c::NtReleaseKeyedEvent(keyed_event_handle(), self.ptr(), false, ptr::null_mut());
        }
    }

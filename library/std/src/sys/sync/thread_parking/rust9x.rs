    ...
    pub unsafe fn new_in_place(parker: *mut Parker) {
        ...
        match impl_ {
            ThreadParkingImpl::Futex => unsafe {
                super::futex::Parker::new_in_place(&mut (*(*parker).futex))
            },
            ThreadParkingImpl::KeyedEvent => unsafe {
                super::windowsxp::Parker::new_in_place(&mut (*(*parker).keyed_event))
            },
            ThreadParkingImpl::Generic => unsafe {
                super::generic::Parker::new_in_place(&mut (*(*parker).generic))
            },
        }
    }
